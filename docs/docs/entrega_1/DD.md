...
| tipoItem         | VARCHAR(20)  | Tipo geral do item (ex: arma, poção).           | a–z, A–Z              | Não                      | Não                 | tipoItem === { 'CONSUMIVEL', 'ARMA', 'ARMADURA'}                |
...
| categoriaArma         | VARCHAR(20)  | Tipo da arma (Espada, Adaga, Lança...)           | a–z, A–Z              | Não                      | Não                 | -                   |
